<?php /* Smarty version Smarty-3.1.16, created on 2014-04-16 11:25:35
         compiled from "E:\apache\www\study\admin.\template\agencies_encashment_list.mad" */ ?>
<?php /*%%SmartyHeaderCode:18366534de81044d6a3-70943893%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dae9dc76edff3e42b78c2081121e8c8248bcdae5' => 
    array (
      0 => 'E:\\apache\\www\\study\\admin.\\template\\agencies_encashment_list.mad',
      1 => 1397618288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18366534de81044d6a3-70943893',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_534de81049ff41_87813673',
  'variables' => 
  array (
    'vp' => 0,
    'rows' => 0,
...
<?php if ($_valid && !is_callable('content_534de81049ff41_87813673')) {function content_534de81049ff41_87813673($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\apache\\www\\study\\inc\\module\\smarty\\plugins\\modifier.date_format.php';
?>
<!--  快速转换位置按钮  -->
...
<input name="checkboxid[<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
]" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="np"></td>
    <td><span style="color:#ff0000"><?php echo $_smarty_tpl->tpl_vars['v']->value['domain'];?>
</span></td>
...
元</td>
    ...
    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['pay_email'], ENT_QUOTES, 'UTF-8', true);?>
</td>
    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['pay_name'], ENT_QUOTES, 'UTF-8', true);?>
</td>
    <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['add_time'],"%Y/%m/%d");?>
</td>
    <td><?php if ($_smarty_tpl->tpl_vars['v']->value['expense_status']==0) {?> <a href="javascript:;"  onclick="AgenciesPayit('<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
',this);">打款</a> <?php } else { ?>已打款<?php }?></td>
</tr>
<?php } ?>
<tr bgcolor="#FAFAF1">
